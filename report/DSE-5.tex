...
%     \small % 字體大小
%     \noindent\parbox{\textwidth}{ % 限制寬度為正文寬度
%         \noindent\textbf{文章重點：}\par % 手動設置標題
%         \vspace{1ex} % 與正文間距
%     }
% }{\par\vspace{2ex}}
% \newenvironment{keypoints}{
% 	\begin{abstract} % 使用摘要環境來模仿寬度
% 		\noindent\textbf{文章重點：}\par % 標題樣式
% 		\vspace{1ex}
% 	}{
% 	\end{abstract}
% }
%     \small % 字體大小
%     \noindent\parbox{\linewidth}{ % 限制寬度為頁面正文寬度
%         \noindent\center\textbf{文章重點}\par % 標題樣式
%         \vspace{1ex} % 與正文間距
%     }
% }{\par\vspace{2ex}}
